...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    private Button dateButton, timeButton; // varibles(composonts) sous les objets
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // ==> Désactiver la saisie de texte, cela rend les champs de texte non modifiable par l'utilisateur.
        ...
        //Appelle des fonctions "initDatePicker()" et "initTimePicker() :
        initDatePicker();
        ...
        //Evenements des boutons "btnBook" et "btnBack"
    ...
    private void initDatePicker(){
        DatePickerDialog.OnDateSetListener dateSetListener = new DatePickerDialog.OnDateSetListener() {
            @Override
            public void onDateSet(DatePicker datePicker, int i, int i1, int i2) { //(DatePicker datePicker, int year, int month, int date)
                i1=i1+1;
    ...
    private void initTimePicker(){
        TimePickerDialog.OnTimeSetListener timeSetListener = new TimePickerDialog.OnTimeSetListener() {
            @Override
            public void onTimeSet(TimePicker timePicker, int i, int i1) { //(TimePicker view, int hourOfDay, int minute)

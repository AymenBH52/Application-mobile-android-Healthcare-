...
public class BuyMedicineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // When click on go to cart, go to CartBuyMedicineActivity
        ...
        // When click on Back button, go to HomeActivity
        ...
        // When click on item, go to BuyMedicineDetailsActivity with the details of the item(name, detail, cost)
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                String package_name = packages[i][0];
                String package_cost = packages[i][4];
                String package_detail = package_details[i];
                Intent intent = new Intent(BuyMedicineActivity.this, BuyMedicineDetailsActivity.class);
                intent.putExtra("text1", package_name);
                intent.putExtra("text2", package_detail);
                intent.putExtra("text3", package_cost);

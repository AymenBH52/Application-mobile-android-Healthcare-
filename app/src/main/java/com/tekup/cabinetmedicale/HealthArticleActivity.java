...
public class HealthArticleActivity extends AppCompatActivity {
    ...
    // we have 2 arrays, one for the article and the other for the images,
    // same length, data(of 2 arrays) related to each other by the index
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // When click on item, go to HealthArticlesDetailsActivity with the details of the item
